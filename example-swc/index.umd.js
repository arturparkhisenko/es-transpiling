(function(global, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        factory(exports, require('./empty'), require('./unused'), require('./zombie'));
    } else {
        var mod = {
            exports: {
            }
        };
        factory(mod.exports, global.empty, global.unused, global.zombie);
        global.index = mod.exports;
    }
})(this, function(_exports, _empty, _unused, zombie) {
    'use strict';
